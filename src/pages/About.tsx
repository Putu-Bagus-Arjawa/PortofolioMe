  ...
  return (
    <section className="sm:h-screen mb-14 h-auto flex flex-col items-center" id="about">
        <div className="flex flex-col mb-24">
            <h3 className="font-LuckiestGuy text-primary text-2xl md:text-4xl text-center">About Me</h3>
        ...
        <article className="flex md:flex-row flex-col justify-center items-center gap-x-8">
            ...
            <div className="md:w-1/3 w-4/5">
                <p className="font-Delius text-secondary mb-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium quae debitis magni laboriosam, fuga, consectetur ipsa illum voluptatum, minus nihil dolor. Similique quos tempore corrupti perferendis labore laboriosam natus nihil!</p>
